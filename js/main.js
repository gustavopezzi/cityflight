$(document).ready(function() {
    ...
    renderer.setClearColorHex(0x212121);
    scene.fog = new THREE.FogExp2(0x1f1f1f, 0.0085);
    ...
    var pointLight = new THREE.PointLight(0x303030, 10, 100);
    scene.add(pointLight);
    
    var monolith = [];
    var monolithGeo = new THREE.CubeGeometry(4, 4, 4); 
    var monolithMat = new THREE.MeshPhongMaterial({color: 0x222222}); 
    ...
    $("#gl-output").append(renderer.domElement);
});